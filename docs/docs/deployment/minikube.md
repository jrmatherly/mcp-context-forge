...
3. Load the `ghcr.io/ibm/mcp-context-forge:1.0.0rc1` image into Minikube.
...
This target builds the `ghcr.io/ibm/mcp-context-forge:1.0.0rc1` image and loads it into Minikube.
...
* **Pre-cache a remote image:**
  ...
  ```bash
  minikube cache add ghcr.io/ibm/mcp-context-forge:1.0.0rc1
...
* **Load a local tarball:**
  ...
  ```bash
  docker save ghcr.io/ibm/mcp-context-forge:1.0.0rc1 | minikube image load -
  ```
...
| Remove cached image | -                      | `minikube cache delete ghcr.io/ibm/mcp-context-forge:1.0.0rc1` |
