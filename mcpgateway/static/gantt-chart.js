...
class GanttChart {
  ...
  calculateCriticalPath() {
    ...
    const findCriticalPath = (spans) => {
      ...
      spans.forEach((span) => {
        ...
        const totalDuration = (span.duration_ms || 0) + childPath.reduce((sum, s) => sum + (s.duration_ms || 0), 0);
  ...
  renderSpan(span, totalDuration, traceStart) {
    ...
    const leftPercent = (startMs / totalDuration) * 100 * this.zoomLevel + this.panOffset;
